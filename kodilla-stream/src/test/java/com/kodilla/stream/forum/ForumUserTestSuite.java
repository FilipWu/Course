...
public class ForumUserTestSuite {
    ...
    void testGetLocationsOfFriends() {
        ...
        //      user7:  "Washington"
        //      user10: "Miami"
        // user 3 is in  Key West friendsOfFriendsLocations: user 1 - washington, Miami ; user7 - washington ; user2 - null ; user9 - null
        assertEquals(2,user3.getLocationsOfFriendsOfFriends().size());
